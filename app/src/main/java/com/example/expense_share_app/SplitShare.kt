...
class SplitShare : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        s1 = binding.share1EditText.text.toString().toInt()
        s2= binding.share2EditText.text.toString().toInt()
        s3 = binding.share3EditText.text.toString().toInt()
        s4 = binding.share4EditText.text.toString().toInt()
